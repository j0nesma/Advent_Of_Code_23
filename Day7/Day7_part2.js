...
function getHandType(hand) {
    ...
    let joker = 0;
    if (hand.includes('J')) {
        console.log("has Joker");
        joker = getNumberOfCharacters("J", hand);
    }
    switch (numberForEachChar[0]) {
        ...
        case 2:
            if (numberForEachChar[1] === 2) {
                if (joker && numberForEachChar.length === 3) {
                    debug && console.log("Full house");
                    if (getNumberOfCharacters("J", hand) === 2) {
                        return 6;
                    }
                    return 5
                }
            ...
            if (getNumberOfCharacters("J", hand) === 2) {
                debug && console.log("A Pair of Jokers");
                return 4
            }
            return 2 + joker;
        default:
...
// console.log(getHandType("SOPME THIN"));
